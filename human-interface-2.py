...
class InvoiceData(BaseModel):
    ...
    year: str = ""
    invoice_date: str = ""
    list_of_items: conlist(Item) = Field(default_factory=list)
...
st.write("Upload individual invoice documents (PDF, JPG, PNG, etc.) for extraction and review.")
...
if st.button("Start Extraction and Review"):
    ...
    if uploaded_files:
        st.info(f"Processing {len(uploaded_files)} uploaded invoices...")
